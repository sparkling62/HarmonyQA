...
export MASTER_PORT=31879
export TF_CPP_MIN_LOG_LEVEL=3
export LAUNCHER=pytorch
export number=2
OUTPUT_DIR="weights/mos${number}_st2"
...
torchrun \
  ...
  train/stage2_train_AIGV.py \
   --model_name_or_path "weights/mos${number}_st1" \
  --conv_style "internlm2-chat" \
  --output_dir ${OUTPUT_DIR} \
  --meta_path "/home/xuzitong/LOVE_change/Data/image/image_train_r.json"\
