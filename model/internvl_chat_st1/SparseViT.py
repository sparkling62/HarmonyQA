...
class SparseViT(nn.Module):
    def __init__(self, layers=[5, 8, 20, 7], img_size=448, in_chans=3, s_blocks3=[ 8, 4, 2, 1], s_blocks4=[2, 1], embed_dim=[64, 128, 320, 512],
        ...
        for i in range(layers[2]):
            block =  SABlock(
                            dim=embed_dim[2], num_heads=num_heads[2], sparse_size=7, mlp_ratio=mlp_ratio, qkv_bias=qkv_bias, qk_scale=qk_scale,
        ...
        for i in range(layers[3]):
            block = SABlock(
                            dim=embed_dim[3], num_heads=num_heads[3], sparse_size=7, mlp_ratio=mlp_ratio, qkv_bias=qkv_bias, qk_scale=qk_scale,
